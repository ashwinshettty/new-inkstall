...
const Students = () => {
  ...
  const handleRemoveSubject = (index) => {
    ...
    if (newSubjects.length === 0) newSubjects.push({ subject: "", startDate: null, endDate: null });
  ...
  return (
    <MainFrame sx={{ p: 3 }}>
      ...
      <Box sx={{ mb: 4, display: "flex", alignItems: "center", gap: 2 }}>
        <Typography
          variant="h6"
          sx={{ display: "flex", alignItems: "center", gap: 1, fontWeight: "bold", color: "#1a237e" }}
        >
      ...
      <Grid container spacing={3}>
          ...
          <Box sx={{ bgcolor: "#f5f5f5", p: 2, borderRadius: 1, mb: 3 }}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} md={4}>
                <TextField label="Student Name" fullWidth required value={studentName} onChange={(e) => setStudentName(e.target.value)} />
              </Grid>
              <Grid item xs={12} md={4}>
        ...
        <Grid item xs={12}>
          <Box sx={{ bgcolor: "#f5f5f5", p: 2, borderRadius: 1, mb: 3 }}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} md={4}>
                <TextField label="Area" fullWidth value={area} onChange={(e) => setArea(e.target.value)} />
              </Grid>
              <Grid item xs={12} md={4}>
                <TextField label="Landmark" fullWidth value={landmark} onChange={(e) => setLandmark(e.target.value)} />
              </Grid>
              <Grid item xs={12} md={4}>
        ...
        <Grid item xs={12}>
          <Box sx={{ bgcolor: "#f5f5f5", p: 2, borderRadius: 1, mb: 3 }}>
            <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 2 }}>
              <Typography variant="h6" sx={{ color: "#1a237e", fontWeight: 600 }}>Subjects</Typography>
              <Button variant="text" startIcon={<AddIcon />} size="small" sx={{ color: "primary.main" }} onClick={handleAddSubject}>
                Add Subject
              </Button>
            </Box>
          ...
          <Box sx={{ bgcolor: "#f5f5f5", p: 2, borderRadius: 1, mb: 3 }}>
            ...
            <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap", justifyContent: "space-between" }}>
              ...
              <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                ...
                />
                {scholarshipEnabled && (
                  <Select value={scholarshipPercent} onChange={(e) => setScholarshipPercent(e.target.value)} sx={{ minWidth: 80, height: 32 }}>
              ...
              <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                ...
                />
                {oneToOneEnabled && (
                  <Select value={oneToOnePercent} onChange={(e) => setOneToOnePercent(e.target.value)} sx={{ minWidth: 80, height: 32 }}>
