...
const DailyUpdates = () => {
  ...
  const { students: allStudentsList, loading: studentsLoading } = useContext(StudentsContext);
  const { subjects: subjectsList, loading: subjectsLoading } = useContext(SubjectsContext);
  ...
  const getAvailableStudents = (index) => {
    return allStudentsList.filter(
      (student) =>
        !selectedStudents.some((sel, i) => i !== index && sel.student === student.name)
    );
  };
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await api.post("http://localhost:4000/api/daily-updates", payload);
      if (response.status === 200 || response.status === 201) {
        ...
        throw new Error(response.data.message || "Failed to submit daily update");
      }
    } catch (error) {
  ...
  // Wait until both contexts have loaded data
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              ...
              >
                ...
                <Box sx={{ display: "flex", alignItems: "center", width: "100%", flexWrap: "wrap" }}>
                  <Autocomplete
                    ...
                    renderInput={(params) => <TextField {...params} label="Select or search student..." required />}
                  />
                  {student.student && (
                    <Box sx={{ display: "flex", width: "100%", gap: 2, mt: 1, justifyContent: "space-evenly" }}>
                      <Box sx={{ flex: 1 }}>
                        ...
                        <Box sx={{ bgcolor: "#f9f9f9", p: 1.5, border: "1px solid #d3d3d3", borderRadius: "4px", height: "40px", display: "flex", alignItems: "center" }}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 1, mt: 2 }}>
              ...
              <Box sx={{ display: "flex", gap: 2 }}>
                <Box onClick={() => setKSheetGiven("no")} sx={{ display: "flex", flexDirection: "column", alignItems: "center", p: 2, border: kSheetGiven === "no" ? "2px solid #ffcc00" : "2px solid #f5f5f5", borderRadius: "8px", bgcolor: kSheetGiven === "no" ? "#fffdaf" : "#f5f5f5", cursor: "pointer", justifyContent: "center" }}>
                  <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", bgcolor: kSheetGiven === "no" ? "#ffcc00" : "white", width: "40px", height: "40px", borderRadius: "4px", border: kSheetGiven === "no" ? "2px solid #ffcc00" : "2px solid #e0e0e0" }}>
                ...
                <Box onClick={() => setKSheetGiven("textual")} sx={{ display: "flex", flexDirection: "column", alignItems: "center", p: 2, border: kSheetGiven === "textual" ? "2px solid #ffcc00" : "2px solid #f5f5f5", borderRadius: "8px", bgcolor: kSheetGiven === "textual" ? "#fffdaf" : "#f5f5f5", cursor: "pointer", justifyContent: "center" }}>
                  <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", bgcolor: kSheetGiven === "textual" ? "#ffcc00" : "white", width: "40px", height: "40px", borderRadius: "4px", border: kSheetGiven === "textual" ? "2px solid #ffcc00" : "2px solid #e0e0e0" }}>
                ...
                <Box onClick={() => setKSheetGiven("yes")} sx={{ display: "flex", flexDirection: "column", alignItems: "center", p: 2, border: kSheetGiven === "yes" ? "2px solid #ffcc00" : "2px solid #f5f5f5", borderRadius: "8px", bgcolor: kSheetGiven === "yes" ? "#fffdaf" : "#f8f8f8", cursor: "pointer", justifyContent: "center" }}>
                  <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", bgcolor: kSheetGiven === "yes" ? "#ffcc00" : "white", width: "40px", height: "40px", borderRadius: "4px", border: kSheetGiven === "yes" ? "2px solid #ffcc00" : "2px solid #e0e0e0" }}>
            ...
            {kSheetGiven === "yes" && (
              <Box sx={{ mt: 2 }}>
                ...
                <Box sx={{ border: "1px dashed #d3d3d3", borderRadius: "8px", p: 3, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", cursor: "pointer", height: "100px", width: "50%", position: "relative", left: "50%", transform: "translateX(-50%)", "&:hover": { border: "1px dashed #ffcc00" } }}>
                  <Box component="label" htmlFor="upload-ksheet" sx={{ display: "flex", flexDirection: "column", alignItems: "center", cursor: "pointer", width: "100%", height: "100%", justifyContent: "center" }}>
                    <input id="upload-ksheet" type="file" accept=".doc,.docx,.pdf,.jpeg,.jpg,.png" style={{ display: "none" }} onChange={handleFileSelect} />
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 1, mt: 2 }}>
              ...
              <Box sx={{ justifyContent: "space-around", display: "flex" }}>
                <Box onClick={() => setChapterCompletion("25%")} sx={{ display: "flex", flexDirection: "column", alignItems: "center", cursor: "pointer" }}>
                  <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", bgcolor: ["25%", "50%", "75%", "100%"].indexOf(chapterCompletion) >= 0 ? "#4a6bdf" : "#e0e0e0", color: ["25%", "50%", "75%", "100%"].indexOf(chapterCompletion) >= 0 ? "white" : "black", width: "60px", height: "60px", borderRadius: "8px", fontWeight: "bold" }}>
                    25%
                  </Box>
                ...
                <Box onClick={() => setChapterCompletion("50%")} sx={{ display: "flex", flexDirection: "column", alignItems: "center", cursor: "pointer" }}>
                  <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", bgcolor: ["50%", "75%", "100%"].indexOf(chapterCompletion) >= 0 ? "#4a6bdf" : "#e0e0e0", color: ["50%", "75%", "100%"].indexOf(chapterCompletion) >= 0 ? "white" : "black", width: "60px", height: "60px", borderRadius: "8px", fontWeight: "bold" }}>
                    50%
                  </Box>
                ...
                <Box onClick={() => setChapterCompletion("75%")} sx={{ display: "flex", flexDirection: "column", alignItems: "center", cursor: "pointer" }}>
                  <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", bgcolor: ["75%", "100%"].indexOf(chapterCompletion) >= 0 ? "#4a6bdf" : "#e0e0e0", color: ["75%", "100%"].indexOf(chapterCompletion) >= 0 ? "white" : "black", width: "60px", height: "60px", borderRadius: "8px", fontWeight: "bold" }}>
                    75%
                  </Box>
                ...
                <Box onClick={() => setChapterCompletion("100%")} sx={{ display: "flex", flexDirection: "column", alignItems: "center", cursor: "pointer" }}>
                  <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", bgcolor: chapterCompletion === "100%" ? "#4a6bdf" : "#e0e0e0", color: chapterCompletion === "100%" ? "white" : "black", width: "60px", height: "60px", borderRadius: "8px", fontWeight: "bold" }}>
                    100%
                  </Box>
            ...
            <Button variant="contained" onClick={handleSubmit} sx={{ mt: 3, bgcolor: "#ffcc00", color: "white", "&:hover": { bgcolor: "#e6b800" }, py: 1.5, fontWeight: "bold" }} startIcon={<IoMdCheckmarkCircleOutline />} fullWidth>
              Submit Update
            </Button>
          </Box>
        </Box>
